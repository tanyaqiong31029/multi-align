...
3. **金标准对齐基准**：内部小型回归集（自建用例、人工标注），7 个多语用例（中英 / 中日 / 英法 / 英德 / 英西）覆盖 1-1 / 1-2 / 2-1 句对变换、段落锚定、数字锚点与字幕时间轴锚点，当前**宏平均 F1 = 100%**——该数字衡量"已声明能力不被改动破坏"，不代表公开大规模语料上的通用准确率；CI 在 F1 < 97% 时拒绝合并。
